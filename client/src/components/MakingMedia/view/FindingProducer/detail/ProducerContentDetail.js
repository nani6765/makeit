...
function ProducerContentDetail(props) {
  return (
    <div style={{ filter: "drop-shadow(5px 3px 4px rgba(0, 0, 0, 0.25))" }}>
      ...
      >
        <a
          ...
          style={{
            ...
            background: "#DEC3F8",
            boxShadow:
              "0px 2px 10px rgba(178, 3, 108, 0.03), 0px 9px 30px rgba(163, 1, 79, 0.05)",
            position: "relative",
            zIndex: "1",
          }}
        >
      ...
      >
        <div id="detail" style={{ background: "white", padding: "15px" }}>
          <p
            style={{
        ...
        <div id="price" style={{ background: "white", padding: "15px" }}>
          <p
            style={{
              borderBottom: "1px solid #CACACA",
              paddingBottom: "10px",
          ...
          <div>{props.PostInfo.priceInfo}</div>
        </div>
        <div id="edit" style={{ background: "white", padding: "15px" }}>
          <p
            style={{
              borderBottom: "1px solid #CACACA",
              paddingBottom: "10px",

    ...
    return (
        <FilterDiv>
            ...
            <div className="deadline">
                <DatePicker className="date" selected={props.Deadline} onChange={(date) => props.setDeadline(date)} minDate={new Date()}/>
            </div>
            ...
            <div className="Uniqueness">
                <input type="text" value={props.Uniqueness} onChange={(e) => props.setUniqueness(e.currentTarget.value)} />
                <p>** 진행 장소 및 촬영에 요구되는 특이사항(영상목적 등)이 있다면 적어주세요.</p>
            </div>
        </FilterDiv>
    )
}

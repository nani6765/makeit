...
import { DetailFilterDiv } from "../../../../css/RVDCSS.js";
...
function RequestDetailFilter(props) {
  ...
  return (
    <DetailFilterDiv>
      ...
      <div className="filterContent line bold">
        {props.PostInfo.oneLineIntroduce}
      </div>
      ...
      <div className="checkbox">
        {FilmTypeArr.map((film, idx) => {
          return (
            <>
              <div
                className={film === props.PostInfo.filmType ? "checked" : null}
              ></div>

        ...
        <SearchBody>
          ...
          <div className="result">
            <div className="resultHeader">
              <p><span>"영상 제작"</span> 검색 결과 ({MakingLength})</p>
              <button>더보기 &gt;</button>
            </div>
            {MakingLength > 0 &&
          ...
          <div className="result">
            <div className="resultHeader">
              <p><span>"영상 참여"</span> 검색 결과 ({PartLength})</p>
              <button>더보기 &gt;</button>
            </div>
            {PartLength > 0 &&
                ...
                return (
                  <Link to={"/participate/post/"+participate.url} key={idx}>
                    <PostCard>
                      ...
                      <p className="category">{partTransferType(participate.type)}</p>
                    </PostCard>
                  </Link>
                );
              })}
          ...
          <div className="result">
            <div className="resultHeader">
              <p><span>"커뮤니티"</span> 검색 결과 ({CoLength})</p>
              <button>더보기 &gt;</button>
            </div>
            {CoLength > 0 &&
